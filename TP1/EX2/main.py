...
def t_QUANTIA(t):
    ...
    listaDeMoedas = re.findall(r'(c[0-9]?[0-9]?|e[1-9])', t.value) #proura em t.value por todas as ocurrências de moedas seja ela válida ou não
...
for tok in lexer:
    if tok.type == 'QUANTIA':
        ...
        while total > 0:
            ...
            if total > 0:
                print(f"Não é possível dar troco\nCaixa sem moedas")
